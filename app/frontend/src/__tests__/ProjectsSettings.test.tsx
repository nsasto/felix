...
describe('SettingsScreen - Projects Category', () => {
  ...
  describe('Projects Category Navigation', () => {
    ...
    it('switches to Projects settings when category is clicked', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Manage registered Felix projects')).toBeInTheDocument();
      });
    });
  ...
  describe('Projects List Display', () => {
    ...
    it('displays empty state when no projects registered', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText(/Register a Felix project to get started/)).toBeInTheDocument();
      });
    });
  ...
  describe('Project Registration', () => {
    ...
    it('opens register form when button is clicked', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByPlaceholderText(/path\\to\\your\\project/i)).toBeInTheDocument();
    ...
    it('closes register form when cancel is clicked', async () => {
      ...
      await waitFor(() => {
        expect(screen.queryByPlaceholderText(/path\\to\\your\\project/i)).not.toBeInTheDocument();
      });
    });
    ...
    it('disables register button when path is empty', async () => {
      ...
      await waitFor(() => {
        const registerButton = screen.getByRole('button', { name: 'Register Project' });
    ...
    it('calls registerProject API when form is submitted', async () => {
      ...
      // Fill in the form
      fireEvent.change(screen.getByPlaceholderText(/path\\to\\your\\project/i), {
  ...
  describe('Project Unregistration', () => {
    ...
    it('shows confirmation dialog when Unregister is clicked', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/Remove this project from Felix\?/)).toBeInTheDocument();
        expect(screen.getByText(/Files will remain on disk/)).toBeInTheDocument();
    ...
    it('hides confirmation dialog when Cancel is clicked', async () => {
      ...
      const confirmationCancel = cancelButtons.find(btn => 
        btn.closest('[class*="border-t"]') !== null
      );
      ...
      await waitFor(() => {
        expect(screen.queryByText('Confirm Unregister')).not.toBeInTheDocument();
      });
    });
  ...
  describe('Project Configuration', () => {
    ...
    it('opens configuration panel when Configure is clicked', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText(/Display name for this project/)).toBeInTheDocument();
      });
    });
    ...
    it('sorts projects by registration date (most recent first)', async () => {
      ...
      await waitFor(() => {
        ...
        const projectNames = projectCards
          .filter(el => el.textContent === 'Project One' || el.textContent === 'Project Two' || el.textContent === 'Active Project')
