...
| /api/agents/register-sync | POST     | Register CLI agent (upsert)                             |
| /api/runs                 | POST     | Create new run                                          |
| /api/runs/{id}/events     | POST/GET | Append / query events                                   |
| /api/runs/{id}/files      | POST/GET | Upload / list artifact files                            |
| /api/runs/{id}/finish     | POST     | Complete run and mark requirement done                  |
| /api/sync/work/next       | GET      | Claim next planned requirement (team mode, skip-locked) |
| /api/sync/work/start      | POST     | Transition claimed requirement: reserved → in_progress  |
| /api/sync/work/release    | POST     | Release claim — returns requirement to planned          |
| /api/sync/specs/check     | POST     | Spec manifest diff — returns missing/outdated files     |
| /api/sync/specs/file      | GET      | Download individual spec or .meta.json file             |
| /api/events               | GET      | SSE broadcast stream for live UI updates                |
...
git checkout <commit-hash> -- path/to/file.ps1
...
6. [ ] Run storage cleanup (optional - orphaned files don't cause harm)
7. [ ] Verify health check returns 200
8. [ ] Monitor for errors
9. [ ] Communicate status to users
...
| ------------------------- | ------- | ------- |
| /api/agents/register-sync | 100/min | Sliding |
...
| /api/sync/work/next       | 100/min | Sliding |
| /api/sync/work/start      | 100/min | Sliding |
| /api/sync/work/release    | 100/min | Sliding |
| /api/sync/specs/check     | 100/min | Sliding |
| /api/sync/specs/file      | 100/min | Sliding |
