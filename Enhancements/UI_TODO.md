...
2. Consolidate duplicate components (done)
...
3. Enforce shadcn primitives + Lucide icons only (done)
...
5. Centralize repeated UI patterns (done)
...
6) Add lightweight UI audit tooling (done)
