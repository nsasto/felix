...
- Modernized interactive CLI setup flows with searchable Spectre.Console-based `felix setup`, `felix agent setup`, and `felix agent use`
- Added install guidance and curated model selection for supported local agent providers
